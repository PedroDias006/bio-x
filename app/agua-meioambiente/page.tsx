...
>
  ...
  priority
  quality={90}
  className="w-[78vw] max-w-[320px] md:max-w-[380px] lg:w-[clamp(390px,31vw,470px)] lg:max-w-none h-auto object-contain drop-shadow-[0_40px_55px_rgba(0,0,0,0.85)] transition-transform duration-700 hover:scale-105 hover:-translate-y-2"
/>
</motion.div>
        </div>
      </section>
