      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-gradient-to-b from-amber-50 to-white">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ x: -50, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 0.6 }}>
            ...
            <button onClick={() => addToCart({ ...PRODUCT, tag: "Bovinos", rating: 5.0 })} className="w-full sm:w-auto px-10 py-5 bg-slate-900 hover:bg-amber-600 text-white font-bold rounded-sm shadow-xl transition-all uppercase text-xs tracking-widest flex items-center justify-center gap-3">
