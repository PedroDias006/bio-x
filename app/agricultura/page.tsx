        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-serif font-normal uppercase tracking-wide text-[#1A1A1A] leading-tight mb-8">
                Ensaio em batata com <span className="italic text-[#D4AF37]">leitura técnica.</span>
              </h2>

              <p className="text-base md:text-lg font-light leading-relaxed text-[#666666] mb-8">
                O Relatório Final IPACER - Experimento Batata BIO-X avaliou o uso da tecnologia BIOX Agricultura Única em batata Ágata, combinando etapa em casa de vegetação e cultivo em campo.
              </p>
              ...
              <div className="rounded-sm border-l-4 border-[#D4AF37] bg-white p-6 shadow-sm">
                <p className="text-sm font-light leading-relaxed text-[#4A4A4A]">
                  A conclusão técnica foi conservadora: nas condições testadas, o ensaio não apontou diferença estatística entre os tratamentos. O valor do estudo está em orientar dose, variedade e cenário de aplicação com base em dados reais.
                </p>
                <p className="mt-4 text-[10px] font-sans font-semibold uppercase tracking-[0.25em] text-[#1A2E25]/60">
                  Fonte: Relatório Final IPACER - Experimento Batata BIO-X, nov. 2024
                </p>
              </div>
            </motion.div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {IPACER_CASE_METRICS.map((metric, index) => (
                ...
                >
                  <metric.icon className="mb-5 text-[#D4AF37]" size={30} strokeWidth={1.4} />
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-3">
            {IPACER_CASE_FINDINGS.map((item, index) => (
              ...
              >
                <item.icon className="mb-4 text-[#1A2E25]" size={26} strokeWidth={1.4} />
