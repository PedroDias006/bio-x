...
const FLYER_BENEFITS = [
  {
    title: "Saúde e Equilíbrio do Solo",
    desc: "Auxilia no condicionamento do solo e no manejo sustentável da matéria orgânica.",
    icon: Leaf,
  },
  {
    title: "Mais Eficiência no Manejo",
    desc: "Contribui para melhores condições de manejo e maior eficiência operacional.",
    icon: Sprout,
  },
  {
    title: "Nutrientes Disponíveis",
    desc: "Favorece o aproveitamento dos nutrientes presentes no solo e na matéria orgânica.",
    icon: Droplets,
  },
  {
    title: "Produtividade Sustentável",
    desc: "Apoia o desenvolvimento das plantas e o potencial produtivo das culturas.",
    icon: Sun,
  },
  {
    title: "Sustentabilidade em Ação",
    desc: "Solução alinhada às boas práticas agrícolas e à produção responsável.",
    icon: Globe2,
  },
];
...
const FLYER_APPLICATIONS = [
  {
    ...
    desc: "Auxilia no condicionamento do solo e no manejo da matéria orgânica.",
    icon: Sprout,
  },
  {
    title: "Desenvolvimento das Culturas",
    desc: "Contribui para melhores condições para o desenvolvimento das plantas.",
    icon: Leaf,
  },
  {
    title: "Eficiência no Uso de Recursos",
    desc: "Favorece o melhor aproveitamento dos nutrientes presentes no solo.",
    icon: Droplets,
  },
  {
    title: "Produtividade e Qualidade",
    desc: "Apoia o potencial produtivo e a qualidade das culturas.",
    icon: Sun,
  },
  {
    title: "Práticas Sustentáveis",
    desc: "Solução alinhada às boas práticas e à produção responsável.",
    icon: ShieldCheck,
  },
  {
    title: "Equilíbrio Ambiental",
    desc: "Contribui para a sustentabilidade e o equilíbrio do sistema produtivo.",
    icon: Globe2,
  },
];
...
const FLYER_DIFFERENTIALS = [
  {
    title: "Compostos Orgânicos Funcionais",
    desc: "Formulação à base de compostos orgânicos e extratos vegetais.",
    icon: Leaf,
  },
  {
    title: "Tecnologia de Alta Performance",
    desc: "Processos modernos que garantem qualidade e eficiência.",
    icon: Microscope,
  },
  {
    title: "Resultados Consistentes",
    desc: "Solução desenvolvida para entregar resultados reais no campo.",
    icon: BarChart3,
  },
  {
    title: "Segurança e Confiança",
    desc: "Produto seguro para aplicação e alinhado às exigências do agronegócio.",
    icon: ShieldCheck,
  },
  {
    title: "Sustentabilidade e Responsabilidade",
    desc: "Compromisso com o meio ambiente e com as futuras gerações.",
    icon: Globe2,
  },
];
...
const PROOF_CARDS = [
  ...
  },
  {
    ...
    image: "/images/agriculture-harvest.webp",
    icon: BarChart3,
  },
];
...
const YOUTUBE_VIDEOS = [
  {
    ...
    desc: "Acesse pelo YouTube uma reportagem sobre produtividade da soja no campo.",
    href: "https://youtu.be/yp_JN9YrFGk?is=M2EnojS2MiN2A38w",
  },
  {
    title: "Brasil entre os Maiores Produtores de Banana",
    desc: "Acesse pelo YouTube um conteúdo sobre a força da produção brasileira de banana.",
    href: "https://youtu.be/bEtWQHw09Uw?is=CUM8111cJkbn9ZIc",
  },
  {
    title: "Biológicos no Campo: Colheita de Tomate",
    desc: "Acesse pelo YouTube um vídeo sobre o uso de biológicos na produtividade do tomate.",
    href: "https://youtu.be/UpC_Ix-Wsus?is=r2l4p7jRcGRxiXZg",
  },
  {
    title: "Colheita da Soja em Minas Gerais",
    desc: "Acesse pelo YouTube uma reportagem sobre a colheita da soja em Minas Gerais.",
    href: "https://youtu.be/cfITaE4PRdc?is=vCkxP6rl171uIzuS",
  },
];
...
export default function AgroAntPage() {
  ...
  return (
    <main
      ref={containerRef}
      className="bg-[#FBFBF9] text-[#1A1A1A] overflow-x-hidden font-sans selection:bg-[#D4AF37]/20 selection:text-[#1A1A1A]"
    >
      <motion.div
        style={{ scaleX }}
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-x-8 gap-y-12 border-t border-white/10 pt-16">
            {FLYER_BENEFITS.map((item, index) => (
              ...
              >
                <item.icon
                  className="text-[#D4AF37] mb-6 transition-transform duration-500 group-hover:scale-110 group-hover:-translate-y-2"
                  size={42}
                  strokeWidth={1}
                />
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-start">
            ...
            >
              ...
              <p className="text-base font-light leading-relaxed text-[#666666] mb-12 border-l-2 border-[#D4AF37] pl-6">
                A Agro Ant é uma solução tecnológica desenvolvida para auxiliar
                no manejo sustentável do solo e das culturas, promovendo
                melhores condições para o desenvolvimento das plantas e maior
          ...
          <div className="mt-32">
            ...
            <div className="grid grid-cols-2 md:grid-cols-6 gap-8 text-center">
              {FLYER_APPLICATIONS.map((item, index) => (
                ...
                >
                  <item.icon
                    className="text-[#1A2E25] mb-4 transition-transform duration-500 group-hover:scale-110 group-hover:text-[#D4AF37]"
                    size={36}
                    strokeWidth={1.2}
                  />
                ...
                return (
                  <div
                    ...
                    className={`
                      ...
                      ${
                        isHovered
                          ? "scale-105 z-20 shadow-[0_-10px_40px_rgba(212,175,55,0.15)] border-[#D4AF37]"
                          : "scale-100 border-white/5"
                      }
                    `}
                  >
                    <div>
                      <item.icon
                        className={`mb-6 transition-colors duration-500 ${
                          isHovered ? "text-[#D4AF37]" : "text-white/40"
                        }`}
                        size={38}
                        strokeWidth={1}
                      />
                      ...
                      <h4
                        className={`text-sm font-serif uppercase tracking-wider mb-3 leading-relaxed transition-colors duration-500 ${
                      ...
                      <p
                        className={`text-xs font-light leading-relaxed transition-colors duration-500 ${
                          isHovered ? "text-[#E0DED8]" : "text-[#888888]"
                        }`}
                      >
                        {item.desc}
                      </p>
                    ...
                    <div
                      className={`w-full h-1 mt-6 transition-colors duration-500 rounded-full ${
                        isHovered ? "bg-[#D4AF37]" : "bg-white/10"
                      }`}
                    />
                  </div>
                );
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          <div className="mb-20 text-center max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-serif font-normal uppercase tracking-wide leading-tight text-white mb-6">
              A força da raiz ao{" "}
              <span className="italic text-[#D4AF37]">fruto.</span>
            </h2>

            <p className="text-lg font-light leading-relaxed text-[#888888]">
              Registros visuais do desenvolvimento vegetal, confirmando a
              eficiência estrutural entregue pelas soluções Anthars no campo.
            </p>
          </div>
            ...
            {PROOF_CARDS.map((card, index) => (
              ...
              >
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  ...
                  <h3 className="text-2xl font-serif uppercase tracking-wide text-white mb-3">
                    {card.title}
                  </h3>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto mb-16 max-w-3xl text-center">
            ...
            <p className="text-lg font-light text-[#666666] leading-relaxed">
              Acesse conteúdos selecionados no YouTube sobre produtividade,
              cultivo e tecnologia aplicada ao campo.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6">
            {YOUTUBE_VIDEOS.map((video, index) => (
              <motion.a
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.08 }}
                className="group relative flex min-h-[270px] flex-col justify-between overflow-hidden rounded-sm border border-[#E0DED8] bg-white p-6 shadow-sm transition-all duration-500 hover:-translate-y-2 hover:border-[#D4AF37]/60 hover:shadow-2xl"
              >
                <div className="absolute right-0 top-0 h-28 w-28 translate-x-10 -translate-y-10 rounded-full bg-[#D4AF37]/10 transition-transform duration-500 group-hover:scale-150" />

                <div className="relative z-10">
                  <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-sm bg-[#1A2E25] text-[#D4AF37] transition-colors duration-300 group-hover:bg-[#D4AF37] group-hover:text-[#1A1A1A]">
                    <Play size={20} fill="currentColor" />
                  </div>

                  <span className="mb-4 inline-block text-[10px] font-sans font-semibold uppercase tracking-[0.25em] text-[#D4AF37]">
                    Assistir no YouTube
                  </span>

                  <h3 className="text-xl font-serif uppercase tracking-wide text-[#1A1A1A] leading-snug mb-4">
                    {video.title}
                  </h3>
                ...
                <div className="relative z-10 mt-8 flex items-center justify-between border-t border-[#E0DED8] pt-5">
                  <span className="text-[10px] font-sans font-semibold uppercase tracking-[0.25em] text-[#1A2E25]">
                    Abrir vídeo
                  </span>
