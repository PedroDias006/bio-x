          ...
          <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-serif font-normal uppercase tracking-wide text-white leading-tight mb-8">
                Saneamento em campo com <span className="italic text-[#4BB1D3]">dados reais.</span>
              </h2>

              <p className="text-base md:text-lg font-light leading-relaxed text-[#B8C4CB] mb-8">
                O relatório COPASA/DVTE acompanhou a tecnologia BIO-X Saneamento na ETAF Pampulha, analisando odor, aspecto do efluente e efeitos no canal de lançamento para a Lagoa da Pampulha.
              </p>

              <div className="rounded-sm border border-[#4BB1D3]/20 bg-white/[0.04] p-6">
                <p className="text-sm font-light leading-relaxed text-[#E0DED8]">
                  A experiência apontou redução perceptível de odores, menor incrustação de lodo e sinais visuais de melhoria ambiental. Para DBO, DQO e sólidos, o relatório não registrou mudança significativa de eficiência operacional no curto período avaliado.
                </p>
