      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-10 md:gap-14">
        ...
        <div className="col-span-1">
          ...
          <p className="text-slate-500 leading-relaxed text-[15px]">
            Plataforma corporativa de tecnologias orgânicas funcionais para
            agricultura, saneamento, compostagem e pecuária. Eficiência
            ambiental com visão global.
          </p>
        ...
        <div>
          ...
          <div className="flex gap-3 text-lg">
            <a
              href="https://instagram.com/antharsbiotechnologies"
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 rounded-full bg-slate-50 text-slate-500 hover:bg-[#E1306C] hover:text-white transition-all duration-300"
            >
              <FaInstagram />
            </a>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 rounded-full bg-slate-50 text-slate-500 hover:bg-[#1877F2] hover:text-white transition-all duration-300"
            >
              <FaFacebookF />
            </a>

            <a
              href="https://linkedin.com/company/antharsbiotechnologies"
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 rounded-full bg-slate-50 text-slate-500 hover:bg-[#0A66C2] hover:text-white transition-all duration-300"
            >
              <FaLinkedinIn />
            </a>

            <a
              href="https://wa.me/5531997611343"
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 rounded-full bg-slate-50 text-slate-500 hover:bg-[#25D366] hover:text-white transition-all duration-300"
            >
              <FaWhatsapp />
            </a>
          </div>
        ...
        <div>
          ...
          <p className="text-slate-500 text-[14px] mb-5 leading-relaxed">
            Cadastre-se para receber materiais técnicos, novidades de linha e
            conteúdos sobre manejo sustentável.
          </p>
          ...
          <div className="flex flex-col gap-3">
            ...
            <button className="bg-slate-900 text-white px-6 py-3.5 rounded-xl text-sm font-semibold hover:bg-emerald-600 transition-colors shadow-sm">
              Cadastrar
            </button>
          </div>
        </div>
