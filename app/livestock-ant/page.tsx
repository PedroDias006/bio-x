...
const BENEFITS = [
  {
    icon: Beef,
    title: "Corte",
    text: "Potencial para ganho produtivo em escala.",
  },
  {
    icon: Milk,
    title: "Leite",
    text: "Foco em estabilidade e eficiência do sistema.",
  },
  {
    icon: Sprout,
    title: "Pastagens",
    text: "Integração entre solo, nutrição e produção.",
  },
  {
    icon: Wheat,
    title: "Nutrição",
    text: "Melhor aproveitamento dos recursos produtivos.",
  },
  {
    icon: Leaf,
    title: "Sustentabilidade",
    text: "Menor pressão ambiental por unidade produzida.",
  },
];
...
const DIFFERENTIALS = [
  {
    number: "01",
    title: "Cadeia bovina",
    text: "Solução voltada para sistemas de corte, leite, pastagens e operações pecuárias integradas.",
  },
  {
    number: "02",
    title: "Eficiência do sistema",
    text: "Apoia rotinas produtivas com foco em estabilidade, manejo e melhor aproveitamento dos recursos.",
  },
  {
    number: "03",
    title: "Solo e nutrição",
    text: "Integra a lógica de produtividade animal com qualidade de pastagens, solo e disponibilidade nutricional.",
  },
  {
    number: "04",
    title: "Sustentabilidade",
    text: "Contribui para reduzir a pressão ambiental por unidade produzida em sistemas modernos.",
  },
];
...
const PROCESS = [
  {
    step: "01",
    title: "Mapear",
    text: "Análise do sistema produtivo, tipo de operação, pastagens, manejo e principais desafios.",
  },
  {
    step: "02",
    title: "Aplicar",
    text: "Indicação técnica conforme objetivo da operação: corte, leite, pastagem, nutrição ou ambiência.",
  },
  {
    step: "03",
    title: "Evoluir",
    text: "Acompanhamento para maior estabilidade, eficiência produtiva e crescimento sustentável.",
  },
];

export default function LivestockAntPage() {
  return (
    <main className="min-h-screen bg-black text-white overflow-x-hidden">
        ...
        <div className="relative z-10 mx-auto flex min-h-[100svh] w-full max-w-[1500px] flex-col justify-center px-6 pb-10 pt-[140px] md:px-10 lg:px-16 lg:pt-[155px]">
          <div className="grid items-center gap-10 lg:grid-cols-[0.95fr_1.05fr]">
            ...
            >
              ...
              <div className="mt-7 max-w-[660px] border-l-2 border-[#d6b836] pl-6">
                <p className="text-[18px] font-medium leading-relaxed text-white/88 md:text-[22px]">
                  Linha voltada à bovinocultura, com foco em sistemas de corte,
                  leite, pastagens, nutrição, bem-estar e eficiência produtiva.
                </p>
              </div>
            ...
            >
              ...
              >
                <Image
                  src="/images/bombona-livestock-ant.png"
                  alt="Bombona Livestock Ant"
                  width={850}
                  height={850}
                  priority
          ...
          >
            ...
            <div className="mt-6 border-l-4 border-[#d6b836] bg-gradient-to-r from-[#d6b836]/20 to-transparent px-6 py-5 text-[18px] font-black text-white md:text-[21px]">
              Transformando produtividade pecuária em crescimento sustentável.
            </div>
          </motion.div>
        </div>
      </section>
        ...
        <div className="mx-auto grid max-w-[1250px] items-center gap-14 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          >
            ...
            <p className="mt-6 max-w-[580px] text-[17px] leading-relaxed text-black/60 md:text-[19px]">
              Soluções naturais para melhorar desempenho, manejo, produtividade
              e sustentabilidade da cadeia bovina.
            </p>
            ...
            <div className="relative overflow-hidden rounded-[34px] shadow-[0_30px_80px_rgba(0,0,0,0.18)]">
              ...
              <div className="absolute bottom-7 left-7 right-7">
                ...
                <h3 className="max-w-[560px] text-[30px] font-black leading-[1] tracking-[-0.04em] text-white md:text-[42px]">
                  Produtividade, desempenho e sustentabilidade para a cadeia bovina.
                </h3>
              </div>
            </div>
        ...
        <div className="relative z-10 mx-auto max-w-[1300px]">
          <div className="mb-14 max-w-[760px]">
            ...
            <h2 className="font-serif text-[42px] leading-[0.98] tracking-[-0.04em] text-white md:text-[62px]">
              Inteligência natural para uma pecuária mais produtiva.
            </h2>

            <p className="mt-5 max-w-[680px] text-[17px] leading-relaxed text-white/58">
              Uma linha pensada para conectar desempenho animal, manejo,
              pastagens, nutrição e sustentabilidade em uma mesma estratégia.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-[1200px]">
          <div className="mx-auto mb-14 max-w-[780px] text-center">
            ...
            <h2 className="font-serif text-[42px] leading-[0.98] tracking-[-0.04em] md:text-[62px]">
              Do manejo ao resultado, com visão de cadeia.
            </h2>
          </div>
      ...
      <section className="relative bg-black px-6 py-24 md:px-10 lg:px-16">
        <div className="mx-auto grid max-w-[1300px] items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="grid gap-5 sm:grid-cols-2">
            <div className="relative overflow-hidden rounded-[32px] sm:col-span-2">
              ...
              <div className="absolute bottom-7 left-7">
                ...
                <h3 className="max-w-[620px] text-[34px] font-black leading-[1] tracking-[-0.04em] text-white">
                  Produtividade pecuária com crescimento sustentável.
                </h3>
              </div>
            </div>
            ...
            <div className="rounded-[30px] border border-white/10 bg-white/[0.04] p-7">
              ...
              <p className="text-[15px] leading-relaxed text-white/58">
                Melhor aproveitamento dos recursos disponíveis na operação.
              </p>
            </div>
            ...
            <div className="rounded-[30px] border border-white/10 bg-white/[0.04] p-7">
              ...
              <p className="text-[15px] leading-relaxed text-white/58">
                Mais estabilidade para sistemas de corte, leite e pastagens.
              </p>
            </div>
          </div>
          ...
          <div>
            <p className="mb-4 text-[11px] font-black uppercase tracking-[0.34em] text-[#d6b836]">
              Impacto na cadeia bovina
            </p>

            <h2 className="font-serif text-[42px] leading-[0.98] tracking-[-0.04em] text-white md:text-[62px]">
              Desempenho, manejo e sustentabilidade no mesmo sistema.
            </h2>

            <p className="mt-6 text-[18px] leading-relaxed text-white/62">
              A linha Livestock Ant™ apoia operações que buscam melhor
              produtividade, estabilidade do sistema, eficiência no manejo e
              menor pressão ambiental por unidade produzida.
            </p>
      ...
      <section className="relative overflow-hidden bg-[#07140d] px-6 py-24 text-center md:px-10">
        ...
        <div className="relative z-10 mx-auto max-w-[900px]">
          <Beef className="mx-auto mb-7 text-[#d6b836]" size={48} />

          <h2 className="font-serif text-[42px] leading-[0.98] tracking-[-0.04em] text-white md:text-[68px]">
            Livestock Ant™ para uma cadeia bovina mais eficiente e sustentável.
          </h2>
          ...
          <p className="mx-auto mt-6 max-w-[700px] text-[18px] leading-relaxed text-white/62">
            ...
            sistemas de corte, leite, pastagens e manejo produtivo.
          </p>
