...
const BENEFITS = [
  {
    icon: BarChart3,
    title: "Performance",
    text: "Apoio à estabilidade produtiva e melhor eficiência operacional.",
  },
  {
    icon: ShieldCheck,
    title: "Sanidade",
    text: "Contribui para um ambiente mais equilibrado e manejável.",
  },
  {
    icon: Droplets,
    title: "Dejetos",
    text: "Auxilia no manejo de resíduos e matéria orgânica.",
  },
  {
    icon: Wind,
    title: "Redução de odores",
    text: "Ajuda no controle de odores em sistemas intensivos.",
  },
  {
    icon: Leaf,
    title: "Sustentabilidade",
    text: "Tecnologia natural alinhada à produção responsável.",
  },
];
...
const APPLICATIONS = [
  ...
  "Redução de odores nas instalações",
  "Ambiência em sistemas intensivos",
  "Apoio à estabilidade produtiva",
];
...
const DIFFERENTIALS = [
  {
    ...
    text: "Compostos orgânicos funcionais desenvolvidos para apoiar operações suinícolas modernas.",
  },
  {
    number: "02",
    title: "Eficiência operacional",
    text: "Aplicação prática para rotinas de manejo, instalações e sistemas produtivos intensivos.",
  },
  {
    number: "03",
    title: "Estabilidade ambiental",
    text: "Apoio ao equilíbrio da ambiência, reduzindo pressão operacional sobre a granja.",
  },
  {
    number: "04",
    title: "Escala produtiva",
    text: "Solução pensada para granjas, integrações e operações com alta demanda técnica.",
  },
];
...
const PROCESS = [
  {
    step: "01",
    title: "Diagnosticar",
    text: "Entendimento da operação, desafios de ambiência, manejo de dejetos e rotina produtiva.",
  },
  {
    step: "02",
    title: "Aplicar",
    text: "Indicação técnica conforme estrutura da granja, volume, objetivo e ponto de aplicação.",
  },
  {
    step: "03",
    title: "Acompanhar",
    text: "Avaliação contínua dos resultados, ajustes operacionais e suporte especializado.",
  },
];

export default function SwineAntPage() {
  return (
    <main className="min-h-screen bg-black text-white overflow-x-hidden">
        ...
        <div className="relative z-10 mx-auto flex min-h-[100svh] w-full max-w-[1500px] flex-col justify-center px-6 pb-10 pt-[140px] md:px-10 lg:px-16 lg:pt-[155px]">
          <div className="grid items-center gap-10 lg:grid-cols-[0.95fr_1.05fr]">
            ...
            >
              ...
              <h1 className="font-serif text-[58px] leading-[0.9] tracking-[-0.045em] text-white sm:text-[76px] md:text-[94px] lg:text-[112px]">
                SWINE
                <br />
                <span className="text-[#d6b836]">ANT</span>
              </h1>

              <div className="mt-7 max-w-[640px] border-l-2 border-[#d6b836] pl-6">
                <p className="text-[18px] font-medium leading-relaxed text-white/88 md:text-[22px]">
                  Tecnologia natural para granjas mais eficientes, com foco em
                  ambiência, manejo de dejetos, redução de odores e estabilidade
                  produtiva.
                </p>
              </div>
            ...
            >
              ...
              >
                <Image
                  src="/images/bombona-swine-ant.png"
                  alt="Bombona Swine Ant"
                  width={850}
                  height={850}
                  priority
      ...
      >
        <div className="mx-auto grid max-w-[1250px] items-center gap-14 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          >
            ...
            <h2 className="max-w-[560px] font-serif text-[42px] leading-[0.98] tracking-[-0.04em] md:text-[62px]">
              Produção suína com mais controle e inteligência.
            </h2>

            <p className="mt-6 max-w-[560px] text-[17px] leading-relaxed text-black/60 md:text-[19px]">
              O Swine Ant™ foi pensado para operações que precisam lidar com
              alta concentração animal, manejo de dejetos, odor, estabilidade
              ambiental e produtividade em escala.
            </p>
          ...
          >
            <div className="relative overflow-hidden rounded-[34px] shadow-[0_30px_80px_rgba(0,0,0,0.18)]">
              <Image
                src="/images/swine-showcase.webp"
                alt="Aplicações Swine Ant"
                width={900}
                height={620}
              ...
              <div className="absolute bottom-7 left-7 right-7">
                ...
                <h3 className="max-w-[560px] text-[30px] font-black leading-[1] tracking-[-0.04em] text-white md:text-[42px]">
                  Ambiência e manejo para granjas modernas.
                </h3>
              </div>
            </div>
        ...
        <div className="relative z-10 mx-auto max-w-[1300px]">
          <div className="mb-14 max-w-[760px]">
            ...
            <h2 className="font-serif text-[42px] leading-[0.98] tracking-[-0.04em] text-white md:text-[62px]">
              Tecnologia pensada para o ritmo real da granja.
            </h2>

            <p className="mt-5 max-w-[680px] text-[17px] leading-relaxed text-white/58">
              Mais do que um produto, uma solução para integrar produtividade,
              ambiência, manejo e sustentabilidade em operações suinícolas.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-[1200px]">
          <div className="mx-auto mb-14 max-w-[760px] text-center">
            ...
            <h2 className="font-serif text-[42px] leading-[0.98] tracking-[-0.04em] md:text-[62px]">
              Do diagnóstico à aplicação, com acompanhamento.
            </h2>
          </div>
      ...
      <section className="relative bg-black px-6 py-24 md:px-10 lg:px-16">
        <div className="mx-auto grid max-w-[1300px] items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="grid gap-5 sm:grid-cols-2">
            <div className="relative overflow-hidden rounded-[32px] sm:col-span-2">
              ...
              <div className="absolute bottom-7 left-7">
                ...
                <h3 className="max-w-[620px] text-[34px] font-black leading-[1] tracking-[-0.04em] text-white">
                  Operações intensivas com mais previsibilidade.
                </h3>
              </div>
            </div>
            ...
            <div className="rounded-[30px] border border-white/10 bg-white/[0.04] p-7">
              ...
              <p className="text-[15px] leading-relaxed text-white/58">
                Apoio ao manejo de resíduos e processos ligados à carga orgânica.
              </p>
            </div>

            <div className="rounded-[30px] border border-white/10 bg-white/[0.04] p-7">
              <LineChart className="mb-7 text-[#d6b836]" size={34} />
              <h3 className="mb-3 text-[25px] font-black tracking-[-0.04em]">
                Eficiência
              </h3>
              <p className="text-[15px] leading-relaxed text-white/58">
                Mais controle para rotinas produtivas, manejo e escala.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <h2 className="font-serif text-[42px] leading-[0.98] tracking-[-0.04em] text-white md:text-[62px]">
              Mais equilíbrio para produzir melhor.
            </h2>

            <p className="mt-6 text-[18px] leading-relaxed text-white/62">
              A linha Swine Ant™ foi desenvolvida para apoiar granjas que
              buscam evolução na ambiência, maior controle de resíduos,
              redução de odores e suporte técnico para sistemas produtivos
              exigentes.
            </p>
            ...
            <div className="mt-8 border-l-4 border-[#d6b836] bg-gradient-to-r from-[#d6b836]/20 to-transparent px-6 py-5 text-[19px] font-black text-white md:text-[22px]">
              Mais eficiência produtiva. Menor tempo para resultados.
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden bg-[#07140d] px-6 py-24 text-center md:px-10">
        ...
        <div className="relative z-10 mx-auto max-w-[900px]">
          <PiggyBank className="mx-auto mb-7 text-[#d6b836]" size={48} />

          <h2 className="font-serif text-[42px] leading-[0.98] tracking-[-0.04em] text-white md:text-[68px]">
            Swine Ant™ para granjas que buscam mais controle, estabilidade e
            eficiência.
          </h2>

          <p className="mx-auto mt-6 max-w-[700px] text-[18px] leading-relaxed text-white/62">
            Fale com um especialista Anthars para entender a aplicação ideal
            para sua operação.
          </p>
